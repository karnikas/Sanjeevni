...
public class AddRecep extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtrecepid.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        txtrecepid.setEnabled(false);
        txtrecepid.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtrecepidActionPerformed(evt);
            }
        });
        jPanel2.add(txtrecepid, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 60, 380, -1));

        txtrecepname.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        txtrecepname.setEnabled(false);
        ...
        jPanel2.add(comboempid, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 30, 380, -1));

        jLabel4.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel4.setText("Receptionist ID");
        jPanel2.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 60, 130, 20));

        lblID.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        lblID.setText("Employee ID");
        jPanel2.add(lblID, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 30, 90, 20));
        ...
        jPanel1.add(btnback, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 430, 60, 30));
        ...
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 210, 230, 170));
    ...
    private void comboempidActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_comboempidActionPerformed
        ...
        selEmpName = (String) reclist.get(selEmpId);
    ...
    private void btnregisterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnregisterActionPerformed
        ...
        try
        {
            ...
            recep.setReceptionist_id(txtrecepid.getText());
            recep.setReceptionist_name(selEmpName);
            ...
            user.setUser_type("Receptionist");
            String encpassword= new String(PasswordEncryption.getEncryptedPassword(pass1));
            user.setPassword(encpassword);

            boolean result1= ReceptionistDao.addRecep (recep); //storing results that whether the details are added in both tables or not
    ...
    {
        try{
            reclist=EmpDao.getUnregRecep();
            Set <String> empIDset = reclist.keySet();
    ...
    private void geneNewRecepId(){
        try{
            String  recID= ReceptionistDao.getNewRecepID();
