...
public class ViewConfirmAppointments extends javax.swing.JFrame {
    private static DefaultTableModel model ; 

    public ViewConfirmAppointments() {
        initComponents();
    ...
    private void initComponents() {
        ...
        tableview.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Patient_ID ", "Patient Name", "OPD", "Appointment Scheduled "
            }
        ) {
    ...
    private void btnbackActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnbackActionPerformed
        JFrame newframe= new ViewSinglePatient();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewConfirmAppointments.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewConfirmAppointments().setVisible(true);
            }
        });
    }
    ...
    private void loadAppointments() {
        try
        {
            List <AppointmentPojo> applist = AppointmentDao.getAllconfirmAppointments(); 
            if(applist.isEmpty())
            {
                JOptionPane.showMessageDialog(this, "NO record found");
                return ; 
            }       
                for(AppointmentPojo ap: applist)
                {
