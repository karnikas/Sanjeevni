...
public class RemoveDoctor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(javax.swing.border.EtchedBorder.RAISED), "Remove Doctor", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 14))); // NOI18N
        ...
        jLabel3.setText("Hello, USER-KARNIKA");
        jPanel5.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 10, 280, -1));

        jPanel3.add(jPanel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 10, 570, 40));
        ...
        jPanel3.add(jcidlist, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 70, 220, 30));

        jLabel4.setText("jLabel4");
        jPanel3.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 30, 150, 140));
    ...
    private void btnremoveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnremoveActionPerformed
        String docId=jcidlist.getSelectedItem().toString();
        try{
                DoctorsPojo doc = new DoctorsPojo();
               doc.setDoctor_id(jcidlist.getSelectedItem().toString());
                boolean  result = DoctorsDao.removeDoc(doc); 
                if (result == true) {
                    JOptionPane.showMessageDialog(null, "Doctor successfully Removed");
                    jcidlist.removeItem(docId);
                }
