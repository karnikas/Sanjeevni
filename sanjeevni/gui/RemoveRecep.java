 ...
 * @author HP
 */
public class RemoveRecep extends javax.swing.JFrame {

    /**
     * Creates new form RemoveRecep
     */
    public RemoveRecep() {
        initComponents();
        loadReceptionistId();
    ...
    private void initComponents() {
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(javax.swing.border.EtchedBorder.RAISED), "Remove Receptionist", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 14))); // NOI18N
        ...
        jPanel3.add(jPanel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 10, 610, 40));
        ...
        lbldocid.setText("Receptionist ID");
    ...
    private void btnremoveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnremoveActionPerformed
        ...
        try{
            ...
            rec.setReceptionist_id(jcidlist.getSelectedItem().toString());
            boolean  result = ReceptionistDao.removeRecep(rec);
            if (result == true) {
                JOptionPane.showMessageDialog(null, "Receptionist successfully Removed");
...
this.dispose(); 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RemoveRecep.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RemoveRecep().setVisible(true);
            }
        });
    }
